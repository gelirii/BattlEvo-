...
function stepBattlefield(){
  ...
  // Arrow lanes perpendicular to crossing. All arrows use exactly the same projectile speed.
  if(sim.tick%34===0){
...
function stepInvaders(){
  ...
  for(const n of alive){
    if((sim.orientation===0&&n.y>H-28)||(sim.orientation===2&&n.y<28)||(sim.orientation===1&&n.x<28)||(sim.orientation===3&&n.x>W-28)){sim.endReason='breach';sim.tick=MAX_TICKS.invaders;break;}
  }
